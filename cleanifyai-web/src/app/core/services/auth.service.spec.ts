...
describe('AuthService', () => {
  ...
  it('clears an expired session during bootstrap', () => {
    localStorage.setItem(storageKey, JSON.stringify(buildLoginResponse('ATENDENTE', -60)));
...
function buildLoginResponse(role: 'ADMIN' | 'ATENDENTE', expiresInSeconds: number): LoginResponse {
  return {
